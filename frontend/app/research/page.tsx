...
import { EmptyState, ErrorState, InfoTooltip, LoadingState, StatusBadge } from "@/components/ui";
...
export default function ResearchPage() {
  ...
  </> : <><header className="mb-4"><h1 className="text-lg font-semibold text-foreground">GPT 분석 결과</h1><p className="mt-1 text-xs text-muted">아직 GPT 분석 결과가 없습니다.</p></header>{importArea}<EmptyState title="분석 전" description="분석 JSON을 불러오면 종목별 분석 결과가 표시됩니다."/></>}</>;
}
