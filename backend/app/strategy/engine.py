...
class StrategyReason(StrEnum):
    ...
    # ENTRY_SIGNALLED settlement: a signal settles on its one intended execution bar.
    ENTRY_AWAITING_EXECUTION_BAR = "ENTRY_AWAITING_EXECUTION_BAR"
    ENTRY_SIGNAL_STALE = "ENTRY_SIGNAL_STALE"
    ENTRY_SESSION_ENDED = "ENTRY_SESSION_ENDED"
    ENTRY_PRICE_ABOVE_CEILING = "ENTRY_PRICE_ABOVE_CEILING"
    ENTRY_RISK_REJECTED = "ENTRY_RISK_REJECTED"
    ENTRY_EXECUTION_REJECTED = "ENTRY_EXECUTION_REJECTED"
